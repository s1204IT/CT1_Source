...
int do_booti(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
...
#ifdef CONFIG_MD5
	{
		...
		md5(hdr->kernel_addr,hdr->kernel_size-SUFFIX_LEN,md5_kernel_calc);
		memcpy(md5_kernel_with,hdr->kernel_addr+hdr->kernel_size-SUFFIX_LEN,SUFFIX_LEN);
#ifdef CONFIG_RSA
...
#ifdef CONFIG_MD5
	{
		...
		md5(hdr->ramdisk_addr,hdr->ramdisk_size-SUFFIX_LEN,md5_ramdisk_calc);
		memcpy(md5_ramdisk_with,hdr->ramdisk_addr+hdr->ramdisk_size-SUFFIX_LEN,SUFFIX_LEN);
#ifdef CONFIG_RSA
