...
#define MX6DL_GPIO_1_9_CTRL (PAD_CTL_HYS | PAD_CTL_SRE_FAST | PAD_CTL_DSE_40ohm |	\
		PAD_CTL_SPEED_MED)

#define MX6DL_GPIO_PAD_CTRL0 (PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
#define MX6DL_GPIO_PAD_CTRL1 (PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
...
#ifndef CONFIG_MACH_MX6Q_BEE01
#define MX6DL_PAD_EIM_D25__GPIO_3_25                                           \
		IOMUX_PAD(0x0538, 0x0168, 5, 0x0000, 0, NO_PAD_CTRL)
#else
#define MX6DL_PAD_EIM_D25__GPIO_3_25                                           \
		IOMUX_PAD(0x0538, 0x0168, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#define MX6DL_PAD_ENET_MDIO__GPIO_1_22_PU                                      \
		IOMUX_PAD(0x05BC, 0x01EC, 5, 0x0000, 0, MX6DL_GPIO_PAD_CTRL0)
#define MX6DL_PAD_ENET_MDIO__GPIO_1_22_PD                                      \
		IOMUX_PAD(0x05BC, 0x01EC, 5, 0x0000, 0, MX6DL_GPIO_PAD_CTRL1)
...
#else
#define MX6DL_PAD_GPIO_19__GPIO_4_5                                            \
		IOMUX_PAD(0x05F0, 0x0220, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_GPIO_4__GPIO_1_4                                             \
		IOMUX_PAD(0x05FC, 0x022C, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_GPIO_5__GPIO_1_5                                             \
		IOMUX_PAD(0x0600, 0x0230, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_GPIO_9__GPIO_1_9                                             \
		IOMUX_PAD(0x0610, 0x0240, 5, 0x0000, 0, MX6DL_GPIO_1_9_CTRL)
#endif
...
#else
#define MX6DL_PAD_KEY_COL4__GPIO_4_14                                          \
		IOMUX_PAD(0x063C, 0x0254, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_KEY_ROW4__GPIO_4_15                                          \
		IOMUX_PAD(0x0650, 0x0268, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_NANDF_D4__GPIO_2_4                                           \
		IOMUX_PAD(0x067C, 0x0294, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_NANDF_D6__GPIO_2_6                                           \
		IOMUX_PAD(0x0684, 0x029C, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_NANDF_D7__GPIO_2_7                                           \
		IOMUX_PAD(0x0688, 0x02A0, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
...
#else
#define MX6DL_PAD_SD3_DAT4__GPIO_7_1                                           \
		IOMUX_PAD(0x070C, 0x0324, 5, 0x0000, 0, MX6DL_GPMI_PAD_CTRL0)
#endif
