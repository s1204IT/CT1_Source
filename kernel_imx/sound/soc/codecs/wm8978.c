...
//	0x0038, 0x000b, 0x0032, 0x0000,	/* 0x20...0x23 */
	0x00f8, 0x000f, 0x0132, 0x0000,	/* 0x20...0x23 *//*ALC limit enable*/
	0x0008, 0x000c, 0x0093, 0x00e9,	/* 0x24...0x27 */
	0x0000, 0x0000, 0x0000, 0x0000,	/* 0x28...0x2b */
//	0x0033, 0x0010, 0x0010, 0x0100,	/* 0x2c...0x2f */
	0x0033, 0x0030, 0x0030, 0x0100,	/* 0x2c...0x2f *//*Hedset-mic +24(+44)dBUP  mic +24(+44)dBUP*/
...
static const struct snd_kcontrol_new wm8978_snd_controls[] = {
	...
	SOC_SINGLE("Left Headphone Out Switch", WM8978_POWER_MANAGEMENT_2, 7, 1, 0),

	SOC_SINGLE("Right Headphone Out Switch", WM8978_POWER_MANAGEMENT_2, 8, 1, 0),
	...
	SOC_SINGLE("Left Speaker Out Switch", WM8978_POWER_MANAGEMENT_3, 6, 1, 0),

	SOC_SINGLE("Right Speaker Out Switch", WM8978_POWER_MANAGEMENT_3, 5, 1, 0),
	...
	/* DACR2RMIX */
	SOC_SINGLE("DACR2RMIX Switch", WM8978_RIGHT_MIXER_CONTROL, 0, 1, 0),
	/* DACL2RMIX */
	SOC_SINGLE("DACL2RMIX Switch", WM8978_OUTPUT_CONTROL, 6, 1, 0),

	/* Mic Bias */
	SOC_SINGLE("Mic Bias Switch", WM8978_POWER_MANAGEMENT_1, 4, 1, 0),
	/* LIN2INPPGA */
	SOC_SINGLE("LIN2INPPGA Switch", WM8978_INPUT_CONTROL, 1, 1, 1),
	/* LIP2INPPGA */
	SOC_SINGLE("LIP2INPPGA Switch", WM8978_INPUT_CONTROL, 0, 1, 1),
	/* RIN2INPPGA */
	SOC_SINGLE("RIN2INPPGA Switch", WM8978_INPUT_CONTROL, 5, 1, 1),
	/* RIP2INPPGA */
	SOC_SINGLE("RIP2INPPGA Switch", WM8978_INPUT_CONTROL, 4, 1, 1),
	/* ADCLRSWAP */
	SOC_SINGLE("ADCLRSWAP Switch", WM8978_AUDIO_INTERFACE, 1, 1, 0),
	/* MONO */
	SOC_SINGLE("MONO Switch", WM8978_AUDIO_INTERFACE, 0, 1, 0),
...
//		snd_soc_update_bits(codec, WM8978_GPIO_CONTROL, 7, 0);
		snd_soc_update_bits(codec, WM8978_GPIO_CONTROL, 7, 7);/*GPIO1 ouput low*/
	} else {
		return -EINVAL;
	}
...
#if 0
	printk("WM8978_POWER_MANAGEMENT_3 %lx\n",snd_soc_read(codec, WM8978_POWER_MANAGEMENT_3));
	printk("WM8978_POWER_MANAGEMENT_2 %lx\n",snd_soc_read(codec, WM8978_POWER_MANAGEMENT_2));
	printk("WM8978_OUTPUT_CONTROL %lx\n",snd_soc_read(codec, WM8978_OUTPUT_CONTROL));
	printk("WM8978_LOUT2_SPK_CONTROL %lx\n",snd_soc_read(codec, WM8978_LOUT2_SPK_CONTROL));
	printk("WM8978_ROUT2_SPK_CONTROL %lx\n",snd_soc_read(codec, WM8978_ROUT2_SPK_CONTROL));
	printk("WM8978_BEEP_CONTROL %lx\n",snd_soc_read(codec, WM8978_BEEP_CONTROL));
	printk("WM8978_LEFT_MIXER_CONTROL %lx\n",snd_soc_read(codec, WM8978_LEFT_MIXER_CONTROL));
	printk("WM8978_RIGHT_MIXER_CONTROL %lx\n",snd_soc_read(codec, WM8978_RIGHT_MIXER_CONTROL));
	printk("WM8978_DAC_CONTROL %lx\n",snd_soc_read(codec, WM8978_DAC_CONTROL));
	printk("WM8978_EQ1 %lx\n",snd_soc_read(codec, WM8978_EQ1));
	printk("WM8978_LOUT1_HP_CONTROL %lx\n",snd_soc_read(codec, WM8978_LOUT1_HP_CONTROL));
	printk("WM8978_ROUT1_HP_CONTROL %lx\n",snd_soc_read(codec, WM8978_ROUT1_HP_CONTROL));
	printk("WM8978_INPUT_CONTROL %lx\n",snd_soc_read(codec, WM8978_INPUT_CONTROL));
	printk("WM8978_LEFT_INP_PGA_CONTROL %lx\n",snd_soc_read(codec, WM8978_LEFT_INP_PGA_CONTROL));
	printk("WM8978_RIGHT_INP_PGA_CONTROL %lx\n",snd_soc_read(codec, WM8978_RIGHT_INP_PGA_CONTROL));
	printk("WM8978_LEFT_ADC_BOOST_CONTROL %lx\n",snd_soc_read(codec, WM8978_LEFT_ADC_BOOST_CONTROL));
	printk("WM8978_RIGHT_ADC_BOOST_CONTROL %lx\n",snd_soc_read(codec, WM8978_RIGHT_ADC_BOOST_CONTROL));
	printk("WM8978_POWER_MANAGEMENT_1 %lx\n",snd_soc_read(codec, WM8978_POWER_MANAGEMENT_1));
	printk("WM8978_ADC_CONTROL %lx\n",snd_soc_read(codec, WM8978_ADC_CONTROL));
	printk("WM8978_LEFT_ADC_DIGITAL_VOLUME %lx\n",snd_soc_read(codec, WM8978_LEFT_ADC_DIGITAL_VOLUME));
	printk("WM8978_RIGHT_ADC_DIGITAL_VOLUME %lx\n",snd_soc_read(codec, WM8978_RIGHT_ADC_DIGITAL_VOLUME));
	printk("WM8978_AUDIO_INTERFACE %lx\n",snd_soc_read(codec, WM8978_AUDIO_INTERFACE));
	printk("WM8978_LEFT_DAC_DIGITAL_VOLUME %lx\n",snd_soc_read(codec, WM8978_LEFT_DAC_DIGITAL_VOLUME));
	printk("WM8978_RIGHT_DAC_DIGITAL_VOLUME %lx\n",snd_soc_read(codec, WM8978_RIGHT_DAC_DIGITAL_VOLUME));
	printk("WM8978_CLOCKING %lx\n",snd_soc_read(codec, WM8978_CLOCKING));
#endif
